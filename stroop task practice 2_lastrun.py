...
expName = 'stroop task practice 2'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/charvithakkar/Desktop/PSY310/stroop task practice 2_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/charvithakkar/Desktop/conditions stroop task practice.xlsx'), 
        seed=None, 
    )
